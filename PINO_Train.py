...
# Load one training sample for inspection    l-1-train
train_dataset = train_loader.dataset #train_loader is made from load_2D_AP
index = 0
...
# Building the FNO model structure for training l-3-FNO
model = FC_FNO(n_modes=(8, 16, 16),
             ...
             Lengths=(time_boundary, float(args.mesh_size), float(args.mesh_size)))
